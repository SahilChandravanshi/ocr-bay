...
export default function Home() {
	...
	return (
		<main className="flex min-h-screen flex-col py-4 px-8 gap-2 font-primary  w-full justify-center">
			<p>
			...
			<div className="result mt-2 grid items-center justify-center sm:grid-cols-2 gap-2">
				<div className="bg-white bg-opacity-50 h-72 w-[95vw] sm:w-full sm:h-96 sm:max-h-96 p-1 overflow-y-auto flex flex-col items-center rounded shadow">
					{selectedImage == null ? (
				...
				<div className="bg-white bg-opacity-50 h-72 w-[95vw] sm:w-full sm:h-96 sm:max-h-96 p-1 overflow-y-auto flex flex-col items-center justify-center rounded shadow">
